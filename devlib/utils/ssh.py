...
def ssh_get_shell(host, username, password=None, keyfile=None, port=None, timeout=10, telnet=False, original_prompt=None, options=None):
    _check_env()
    ...
    while True:
        if telnet:
            ...
            conn = pxssh.pxssh(echo=False, options=options)
...
class SshConnection(object):
    ...
    def __init__(self,
        ...
        self.conn = ssh_get_shell(host, username, password, self.keyfile, port, timeout, False, None, self.options)
    ...
    def _scp(self, source, dest, timeout=30):
        ...
        command = '{} {} -r {} {} {} {}'.format(scp, options, keyfile_string, port_string, quote(source), quote(dest))
